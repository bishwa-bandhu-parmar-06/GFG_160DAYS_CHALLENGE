// Make Strings Equal
// Difficulty: MediumAccuracy: 67.38%Submissions: 6K+Points: 4
...
// Your task is to find the minimum total cost required to make the strings identical. If it is impossible to make the two strings identical using the available transformations, return -1.0
